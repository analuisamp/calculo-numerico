...
# Carrega imagens
img_bissecao = pygame.image.load("images/bissecao__.png").convert_alpha()
img_newton = pygame.image.load("images/newton__.png").convert_alpha()
img_secante = pygame.image.load("images/secante__.png").convert_alpha()
...
res_text = font.render('Metodos Numericos', True,(70, 130, 180), None)
...
subtitle = font_subtitle.render('Projeto 1', True,(255, 255, 153), None)
...
btn_newton = Button(center_x, first_button_y + (img_bissecao.get_height() * 1.2), img_newton)
btn_secante = Button(center_x, first_button_y + (img_bissecao.get_height() * 1.2 * 2), img_secante)
